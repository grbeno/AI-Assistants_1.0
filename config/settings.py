...
MIDDLEWARE = [
    ...
    'app.middleware.PortBasedMiddleware',  # custom middleware
]
...
# Simple JWT
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=3),   # minutes=5
    "REFRESH_TOKEN_LIFETIME": timedelta(minutes=5),  # days=1
